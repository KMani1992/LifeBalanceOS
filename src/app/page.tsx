...
import { OVERVIEW_MODULES, OVERVIEW_SPOTLIGHT_STATS } from "@/constants/overview";

const spotlightStats = OVERVIEW_SPOTLIGHT_STATS;

const modules = OVERVIEW_MODULES;
                ...
                <Card sx={{ height: "100%", background: "linear-gradient(180deg, #ffffff, #eef7f3)" }}>
                  <CardContent>
                    <Stack spacing={2.5} sx={{ height: "100%", justifyContent: "space-between" }}>
                      ...
                      <Box sx={{ p: 2.25, borderRadius: 2, bgcolor: "rgba(30, 136, 229, 0.08)" }}>
